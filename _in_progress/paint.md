...
I provide a detailed breakdown of the shader’s implementation, including the math, texture usage, and Unreal Engine material in the post [Post-processing Cross Hatching Line Shader](/blogs/cross_hatching/).
